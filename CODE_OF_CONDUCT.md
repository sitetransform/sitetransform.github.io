# The Sitetransform.css Code of Conduct

Adapted from the [Rust Code of Conduct](https://www.rust-lang.org/en-US/conduct.html) as well as the [Aframe Code of Conduct](https://github.com/aframevr/aframe/tree/master?tab=coc-ov-file).
...
- On Twitter, please avoid using overtly sexual nicknames or other nicknames that
...
- Private harassment is also unacceptable. No matter who you are, if you feel
  ...
  member, please contact one of the channel ops or any of the Sitetransform.css moderation
...
you feel that a thread needs moderation, please contact one of the Sitetransform.css team
members.

- Remarks that violate the Sitetransform.css standards of conduct, including hateful,
...
The initial and interim moderators will be the developers of Sitetransform.css including,
but not limited to, Lau Jia Zheng Quentin <sitetransform.css@gmail.com> and Kavin Viramany
<kavin.viramany@gmail.com>. Contact us if you would like to volunteer and be listed as
a moderator.

In the Sitetransform.css community we strive to go the extra step to look out for each
...
responsibility to make your fellow Sitetransformers comfortable. Everyone wants to
...
The enforcement policies listed above apply to all official Sitetransform.css venues;
primarily the Sitetransform.css GitHub repositories under sitetransform.
For other projects adopting the Sitetransform.css Code of Conduct, please contact the
